    ...
    <div className="min-h-full">
      <main className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
        <Link
          ...
          className="group mb-6 inline-flex items-center gap-2 text-sm font-medium text-violet-600 transition-colors hover:text-violet-700"
        >
        ...
        <Card className="mt-8 overflow-hidden border-violet-200 bg-gradient-to-br from-violet-50 via-sky-50/60 to-white">
