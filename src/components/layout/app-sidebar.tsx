        ...
        {items.map((item) => {
          ...
          return (
            <Link
              ...
              href={href}
              className={cn(
                'group relative flex min-h-10 items-center gap-3 rounded-xl px-3',
                'text-sm font-medium',
    ...
    <aside className="hidden w-[248px] shrink-0 bg-white lg:flex lg:flex-col">
      <div className="flex min-h-0 flex-1 flex-col">
        ...
        <div className="shrink-0 px-4 pb-5">
          <div className="flex items-center gap-3 rounded-xl bg-gradient-to-r from-sky-50 via-blue-50 to-violet-50 px-3 py-2.5">
